                        ...
                        <div class="grid grid-cols-4 gap-4">
                            <div>
                                <div class="relative mr-6 my-2">
                                    <input name="title" value="{{ $data['query']['title'] }}" type="search" class="bg-purple-white shadow rounded border-0 p-3" placeholder="filter by title...">
                                </div>
                            </div>
                            <!-- ... -->
                            <div>
                                <div class="relative inline-flex self-center">
                                    ...
                                    <select name="order-by" class="rounded border-2 text-gray-600 w-60 pl-5 pr-10 bg-white hover:border-gray-400 focus:outline-none appearance-none">
                            ...
                            <!-- component -->
                            <div>
                                <div class=""><button name="submit" type="submit" class="btn bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded align-content: flex-end" href="#">Filter</button></div>
                            </div>
                        </div>
                    </div>
                </form>
